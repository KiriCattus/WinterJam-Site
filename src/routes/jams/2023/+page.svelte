...
<section id="info" class="mt-12">
	<div class="p-5 bg-black bg-opacity-30 rounded-xl">
		...
		<span>
			We've now opened the doors on our yearly Minecraft Server, and the Modpack is now <ExternalLink href="https://curseforge.com/minecraft/modpacks/winterjam-2023" class="underline">available for download on CurseForge!</ExternalLink><br>
