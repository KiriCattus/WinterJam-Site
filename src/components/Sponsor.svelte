...
<a
	...
	title={name}
	class={classNames(
		'bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 bg-opacity-30 border border-gray-200 dark:border-gray-700 divide-gray-200 dark:divide-gray-700 shadow-md flex max-w-sm md:max-w-xl hover:bg-gray-100 dark:hover:bg-gray-700 mb-4 flex-col p-6 items-center gap-2',
